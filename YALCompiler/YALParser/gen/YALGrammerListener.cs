...
public interface IYALGrammerListener : IParseTreeListener {
	...
	void EnterYalg([NotNull] YALGrammerParser.YalgContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="YALGrammerParser.yalg"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitYalg([NotNull] YALGrammerParser.YalgContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCommand([NotNull] YALGrammerParser.CommandContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="YALGrammerParser.command"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCommand([NotNull] YALGrammerParser.CommandContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterBaseExpression([NotNull] YALGrammerParser.BaseExpressionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="YALGrammerParser.baseExpression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitBaseExpression([NotNull] YALGrammerParser.BaseExpressionContext context);
	/// <summary>
