...
public partial class YALGrammerParser : Parser {
	...
	public const int
		...
		OUT=25, STRING=26, ID=27, POSITIVE_NUMBER=28, FLOAT=29, BOOLEAN=30, TIMES=31, 
	...
	private static readonly string[] _SymbolicNames = {
		...
		"RETURN", "TYPE", "IN", "OUT", "STRING", "ID", "POSITIVE_NUMBER", "FLOAT", 
		"BOOLEAN", "TIMES", "DIV", "MOD", "PLUS", "MINUS", "LSHIFT", "RSHIFT", 
		"INCREMENT", "DECREMENT", "LESS_THAN", "LESS_THAN_OR_EQUAL", "GREATER_THAN", 
		"GREATER_THAN_OR_EQUAL", "EQUALS", "NOT_EQUAL", "EQUAL", "PLUS_EQUAL", 
		"MINUS_EQUAL", "MULTIPLY_EQUAL", "DIVIDE_EQUAL", "MODULO_EQUAL", "BITWISE_NOT", 
		"LBRACKET", "RBRACKET", "WHITESPACE", "NEWLINE", "COMMENT", "LINE_COMMENT"
	};
	...
	public ProgramContext program() {
		...
		try {
			...
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 144179200L) != 0) {
				{
				State = 53;
				ErrorHandler.Sync(this);
	...
	public StatementBlockContext statementBlock() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 824783028232L) != 0) {
				{
				State = 134;
				ErrorHandler.Sync(this);
				switch (TokenStream.LA(1)) {
	...
	private ExpressionContext expression(int _p) {
		...
		try {
			...
			case 9:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 4504459629559880L) != 0) {
					{
					State = 217;
					expression(0);
					State = 222;
	...
	private static int[] _serializedATN = {
		...
		0,1,59,1,1,0,0,0,60,66,5,23,0,0,61,63,5,53,0,0,62,64,5,28,0,0,63,62,1,
		0,0,0,63,64,1,0,0,0,64,65,1,0,0,0,65,67,5,54,0,0,66,61,1,0,0,0,66,67,1,
		0,0,0,67,68,1,0,0,0,68,71,5,27,0,0,69,70,5,46,0,0,70,72,3,36,18,0,71,69,
		1,0,0,0,71,72,1,0,0,0,72,73,1,0,0,0,73,74,5,1,0,0,74,3,1,0,0,0,75,76,5,
		19,0,0,76,77,5,40,0,0,77,78,5,26,0,0,78,79,5,42,0,0,79,80,5,27,0,0,80,
		...
		93,5,27,0,0,93,95,5,2,0,0,94,96,3,8,4,0,95,94,1,0,0,0,95,96,1,0,0,0,96,
		...
		1,0,0,0,155,19,1,0,0,0,156,157,5,23,0,0,157,159,5,53,0,0,158,160,5,28,
		0,0,159,158,1,0,0,0,159,160,1,0,0,0,160,161,1,0,0,0,161,162,5,54,0,0,162,
		166,5,27,0,0,163,164,5,23,0,0,164,166,5,27,0,0,165,156,1,0,0,0,165,163,
		...
		1,0,0,0,204,205,1,0,0,0,205,206,1,0,0,0,206,229,5,29,0,0,207,209,5,35,
		0,0,208,207,1,0,0,0,208,209,1,0,0,0,209,210,1,0,0,0,210,229,5,28,0,0,211,
		...
		261,1,0,0,0,261,262,5,27,0,0,262,263,5,3,0,0,263,264,3,34,17,0,264,265,
		...
		0,280,281,3,36,18,0,281,282,5,5,0,0,282,286,1,0,0,0,283,286,5,30,0,0,284,
		...
		341,5,27,0,0,341,342,5,53,0,0,342,343,3,30,15,0,343,344,5,54,0,0,344,351,
		1,0,0,0,345,351,5,27,0,0,346,347,5,3,0,0,347,348,3,48,24,0,348,349,5,5,
