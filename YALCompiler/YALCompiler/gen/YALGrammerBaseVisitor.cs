...
public partial class YALGrammerBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IYALGrammerVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitReferenceableVariableDeclarationFormat([NotNull] YALGrammerParser.ReferenceableVariableDeclarationFormatContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitReferenceableExpression([NotNull] YALGrammerParser.ReferenceableExpressionContext context) { return VisitChildren(context); }
	/// <summary>
